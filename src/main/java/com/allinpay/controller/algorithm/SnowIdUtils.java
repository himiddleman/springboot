package com.allinpay.controller.algorithm;
...
public class SnowIdUtils {
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 100; i++) {
            System.out.println(SnowIdUtils.SnowFlake.SNOW_FLAKE.nextId());
        }


//        System.out.println((System.currentTimeMillis() - 1557489395327L)/(365*24*3600000));
//        System.out.println(~(-1L << 12));
//        System.out.println(~(-1L << 10));
//        System.out.println(new Long(171635403387703328L));
//        System.out.println("1001100001110001010111110101110001110011100001000000100000".length());

        System.out.println(4097 & 4095);
    }
